...
as }
begin
  -- incrementa impegnate/scatole_impegnate per articolo
  ...
  -- marca ordine come "in lavorazione" se vuoi (opzionale)
...
begin
  ...
  loop
    -- scala stock: toglie sia da impegnate che da magazzino.
    -- aggiorniamo entrambe le coppie per sicurezza: (impegnate/scatole_impegnate) e (magazzino/scatole_inventario)
    ...
    -- se quell'ordine non ha più righe NON completate -> completa ordine
    if not exists (
